...
ethercat_msgs__srv__GetSdo_Request__create(void)
{
...
ethercat_msgs__srv__GetSdo_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
ethercat_msgs__srv__GetSdo_Event__init(ethercat_msgs__srv__GetSdo_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    ethercat_msgs__srv__GetSdo_Event__fini(msg);
    return false;
  }
  // request
  if (!ethercat_msgs__srv__GetSdo_Request__Sequence__init(&msg->request, 0)) {
    ethercat_msgs__srv__GetSdo_Event__fini(msg);
    return false;
  }
  // response
  if (!ethercat_msgs__srv__GetSdo_Response__Sequence__init(&msg->response, 0)) {
    ethercat_msgs__srv__GetSdo_Event__fini(msg);
    return false;
  }
  return true;
...
void
ethercat_msgs__srv__GetSdo_Event__fini(ethercat_msgs__srv__GetSdo_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  ethercat_msgs__srv__GetSdo_Request__Sequence__fini(&msg->request);
  // response
  ethercat_msgs__srv__GetSdo_Response__Sequence__fini(&msg->response);
}

bool
ethercat_msgs__srv__GetSdo_Event__are_equal(const ethercat_msgs__srv__GetSdo_Event * lhs, const ethercat_msgs__srv__GetSdo_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!ethercat_msgs__srv__GetSdo_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!ethercat_msgs__srv__GetSdo_Response__Sequence__are_equal(
...
bool
ethercat_msgs__srv__GetSdo_Event__copy(
  const ethercat_msgs__srv__GetSdo_Event * input,
  ethercat_msgs__srv__GetSdo_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!ethercat_msgs__srv__GetSdo_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!ethercat_msgs__srv__GetSdo_Response__Sequence__copy(
...
ethercat_msgs__srv__GetSdo_Event *
ethercat_msgs__srv__GetSdo_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ethercat_msgs__srv__GetSdo_Event * msg = (ethercat_msgs__srv__GetSdo_Event *)allocator.allocate(sizeof(ethercat_msgs__srv__GetSdo_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ethercat_msgs__srv__GetSdo_Event));
  bool success = ethercat_msgs__srv__GetSdo_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
ethercat_msgs__srv__GetSdo_Event__destroy(ethercat_msgs__srv__GetSdo_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ethercat_msgs__srv__GetSdo_Event__fini(msg);
...
bool
ethercat_msgs__srv__GetSdo_Event__Sequence__init(ethercat_msgs__srv__GetSdo_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ethercat_msgs__srv__GetSdo_Event * data = NULL;

  if (size) {
    data = (ethercat_msgs__srv__GetSdo_Event *)allocator.zero_allocate(size, sizeof(ethercat_msgs__srv__GetSdo_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ethercat_msgs__srv__GetSdo_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ethercat_msgs__srv__GetSdo_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
ethercat_msgs__srv__GetSdo_Event__Sequence__fini(ethercat_msgs__srv__GetSdo_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ethercat_msgs__srv__GetSdo_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
ethercat_msgs__srv__GetSdo_Event__Sequence *
ethercat_msgs__srv__GetSdo_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ethercat_msgs__srv__GetSdo_Event__Sequence * array = (ethercat_msgs__srv__GetSdo_Event__Sequence *)allocator.allocate(sizeof(ethercat_msgs__srv__GetSdo_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ethercat_msgs__srv__GetSdo_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
ethercat_msgs__srv__GetSdo_Event__Sequence__destroy(ethercat_msgs__srv__GetSdo_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ethercat_msgs__srv__GetSdo_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
ethercat_msgs__srv__GetSdo_Event__Sequence__are_equal(const ethercat_msgs__srv__GetSdo_Event__Sequence * lhs, const ethercat_msgs__srv__GetSdo_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ethercat_msgs__srv__GetSdo_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
ethercat_msgs__srv__GetSdo_Event__Sequence__copy(
  const ethercat_msgs__srv__GetSdo_Event__Sequence * input,
  ethercat_msgs__srv__GetSdo_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ethercat_msgs__srv__GetSdo_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ethercat_msgs__srv__GetSdo_Event * data =
      (ethercat_msgs__srv__GetSdo_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ethercat_msgs__srv__GetSdo_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ethercat_msgs__srv__GetSdo_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ethercat_msgs__srv__GetSdo_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
