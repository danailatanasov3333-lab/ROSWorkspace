...
static const _GetSdo_Event_type_support_symbol_names_t _GetSdo_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ethercat_msgs, srv, GetSdo_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ethercat_msgs, srv, GetSdo_Event)),
  }
};
...
{
  return &::ethercat_msgs::srv::rosidl_typesupport_cpp::GetSdo_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ethercat_msgs, srv, GetSdo_Event)() {
  return get_message_type_support_handle<ethercat_msgs::srv::GetSdo_Event>();
}
...
static const rosidl_service_type_support_t GetSdo_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ethercat_msgs::srv::GetSdo_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ethercat_msgs::srv::GetSdo_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ethercat_msgs::srv::GetSdo_Event>(),
