...
enum
{
  ethercat_msgs__srv__GetSdo_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ethercat_msgs__srv__GetSdo_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetSdo in the package ethercat_msgs.
typedef struct ethercat_msgs__srv__GetSdo_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ethercat_msgs__srv__GetSdo_Request__Sequence request;
  ethercat_msgs__srv__GetSdo_Response__Sequence response;
} ethercat_msgs__srv__GetSdo_Event;

// Struct for a sequence of ethercat_msgs__srv__GetSdo_Event.
typedef struct ethercat_msgs__srv__GetSdo_Event__Sequence
{
