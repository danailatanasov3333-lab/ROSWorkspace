...
class Init_SetSdo_Event_response
{
public:
  explicit Init_SetSdo_Event_response(::ethercat_msgs::srv::SetSdo_Event & msg)
  : msg_(msg)
  {}
  ::ethercat_msgs::srv::SetSdo_Event response(::ethercat_msgs::srv::SetSdo_Event::_response_type arg)
  {
...
private:
  ::ethercat_msgs::srv::SetSdo_Event msg_;
};

class Init_SetSdo_Event_request
{
public:
  explicit Init_SetSdo_Event_request(::ethercat_msgs::srv::SetSdo_Event & msg)
  : msg_(msg)
  {}
  Init_SetSdo_Event_response request(::ethercat_msgs::srv::SetSdo_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetSdo_Event_response(msg_);
  }
...
class Init_SetSdo_Event_info
{
public:
  Init_SetSdo_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetSdo_Event_request info(::ethercat_msgs::srv::SetSdo_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetSdo_Event_request(msg_);
  }
...
template<>
inline
auto build<::ethercat_msgs::srv::SetSdo_Event>()
{
  return ethercat_msgs::srv::builder::Init_SetSdo_Event_info();
}
