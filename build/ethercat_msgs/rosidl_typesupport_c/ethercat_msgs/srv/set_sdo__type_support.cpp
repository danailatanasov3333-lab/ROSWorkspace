...
static const _SetSdo_Event_type_support_symbol_names_t _SetSdo_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ethercat_msgs, srv, SetSdo_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ethercat_msgs, srv, SetSdo_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ethercat_msgs, srv, SetSdo_Event)() {
  return &::ethercat_msgs::srv::rosidl_typesupport_c::SetSdo_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetSdo_service_type_support_handle = {
  ...
  &SetSdo_Request_message_type_support_handle,
  &SetSdo_Response_message_type_support_handle,
  &SetSdo_Event_message_type_support_handle,
